...
class Dimentions {
  ...
  // Size 220
  static double pageViewController220 = screenHeight! / 3.936;
  // Size 120
  static double pageViewTextContainer120 = screenHeight! / 7.22;
  // Size 320
  static double pageView320 = screenHeight! / 2.71;

  static double pageView350 = screenHeight! / 2.47;
